...
{
	if (m_State[nCntPlayer].Gamepad.sThumbLY >(XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE * 3))
	{
...
{
	if (m_State[nCntPlayer].Gamepad.sThumbRX >(XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE * 3))
	{
		return m_State[nCntPlayer].Gamepad.sThumbRX;
	}
...
{
	if (m_State[nCntPlayer].Gamepad.sThumbRY >(XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE * 3))
	{
		return m_State[nCntPlayer].Gamepad.sThumbRY;
	}
